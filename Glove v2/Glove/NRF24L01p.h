...
// open the dynamix TX pipe, pipe 0 RX address is set to TX address. If enAckPayload is set to true, Ack payload can be sent. If enDynAck, packets with NoAck-flag can be sent or received
